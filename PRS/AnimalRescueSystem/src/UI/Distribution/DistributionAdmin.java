...
public class DistributionAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Manage Delivery Associates");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
                ManageOrders manageInventory = new ManageOrders();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DistributionAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DistributionAdmin().setVisible(true);
            }
        });
    }
